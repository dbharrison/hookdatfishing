...
class HookDatFishingFirebaseUser extends BaseAuthUser {
  ...
  static BaseAuthUser fromFirebaseUser(User? user) =>
      HookDatFishingFirebaseUser(user);
}

Stream<BaseAuthUser> hookDatFishingFirebaseUserStream() => FirebaseAuth.instance
        .authStateChanges()
