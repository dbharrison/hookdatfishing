...
DocumentReference? get currentUserReference =>
    loggedIn ? BookingsRecord.collection.doc(currentUser!.uid) : null;

BookingsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : BookingsRecord.getDocument(BookingsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
